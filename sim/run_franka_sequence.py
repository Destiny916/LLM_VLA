...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--max_steps", type=int, default=120, help="Maximum simulation steps before stopping.")
...
def run_sequence() -> None:
    targets = joint_targets_for_sequence(args_cli.sequence, action_steps=args_cli.action_steps)
